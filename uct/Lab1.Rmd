...
This document is based on an R Notebook. 
...
The title of the file should be your name, and you should include headings for (at least) education or employment. 
...
Once you've done this, show the `html` file to your compatriots around you and I'll come around and check what people have done. 
