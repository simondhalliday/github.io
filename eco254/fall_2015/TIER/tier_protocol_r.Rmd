...
Section I of this protocol describes each of the components that should be included in the documentation for your paper.  Section II describes how these components should be formatted and organized.
...
In addition to the data appendix itself, you should also preserve a do-file that generates all the output (frequency tables, bar charts, summary statistics and histograms) presented in the data appendix.

##Read-me file
Your documentation should include a read-me file that gives information about all the other files included in the documentation. In particular, the read-me file should:

- indicate the version of Stata that was used for the project, and list any packages that need to be installed for your Rmd-files to run

- explain the structure of the directories in which the documentation is stored (instructions on how the directories should be organized are given below in Part II), and briefly describe each of the files included in the documentation
...
##R Markdown files
All of your do-files (those described above in Section I.D. as well as the one described in Section I.E.) should be stored in the "Command files" directory.  It is helpful to give the do-files names that indicate which part of the project each is used for: importing, processing, analysis, or the data appendix.
...
##Readme file
The read-me file should be saved in .txt format, with the name readme.txt.  It should be stored in the top level of the "My Project" directory.
