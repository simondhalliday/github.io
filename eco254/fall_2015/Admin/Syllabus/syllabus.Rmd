...
| Take-home Midterm | 30% | 50% |
| Proposal Presentation | 5% | 55% |
| Team Project | 30% | 85% |
| Final Presentation | 5% | 90% | 
| Experiment Reports | 10% | 100% | 
...
We will use [VEconLab]("http://veconlab.econ.virginia.edu/admin.htm") to run in-class experiments, typically during the Thursday class-times. I'm also investigating an alternative platform, [MobLab]("https://www.moblab.com").


##Moodle & Website
In general, I will use my site, simondhalliday.github.io/eco254 for content for ECO254. We also have a moodle site where the lecture capture software will automatically send lecture recordings. 
...
You have four deadlines that I have imposed for the Team Research Project. 
