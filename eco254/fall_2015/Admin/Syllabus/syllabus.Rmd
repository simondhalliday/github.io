...
##Course Surveys
Please make sure you have completed these surveys by the end of the first week of term. 
...
- Daniel Kaplan [*Data Computing: An Introduction to Wrangling and Visualization with R*](data-computing.org), 2015.  

Supplementary/Recommended text(s):
...
- Nicholas J. Horton  and Ken Kleinman, 2015, [*Using R and R-studio for Data Management, Statistical Analysis and Graphics*]("https://www.crcpress.com/Using-R-and-RStudio-for-Data-Management-Statistical-Analysis-and-Graphics/Horton-Kleinman/9781482237368"), 2nd Edition, CRC Press (Taylor & Francis Press), Florida, USA. 
...
|---|---|---|---|---|
| 9/8-10 |  Intro  |  BE Ch. 1 |  Experiment | - |
| 9/15-17  |  Heuristics |  BE Ch. 2 |  Lab 1 |  ER1 |
| 9/22-24  |  Risk |  BE Ch. 3 |  Lab 2  | - |
| 9/29-10/1  |  Risk |  BE Ch. 3 | Experiment   | - |
| 10/6-10/8 | Time |  BE Ch. 4 | Lab 3   | ER2 |
| 10/10-10/13 | Fall Break | - | - | - |
| 10/15 | Learning & Info |  BE Ch. 5 | Lab 4   | - | 
| 10/20-10/22  | Learning & Info |  BE Ch. 5 | Experiment   |  - |
| 10/27-10/29  |  Group Interactions |  BE Ch. 6 | Lab 5   | ER3 (T); Prop Pres (Th) |
| 11/03  |  Otelia Cromwell Day |   -  |  -  |  -  |
| 11/05  | Group Presentations |   BE Ch. 6  |  Lab 6   |  Midterm |
| 11/10-12 |  Social Preferences |   BE Ch. 7 |  Experiment   | -  |
| 11/17-19 | Social Preferences  |  BE Ch. 7 |  Lab 8   | ER4 |
| 11/24  |  Social Preferences |  BE Ch. 7|  Lab 9  | - |
| 12/1-3  | Happiness & Utility  |  BE Ch. 10 | No Lab   | - |
| 12/8-10  | BE & Policy; Presentations |  Ch. 11 |  - | Project Hand-in |
| 12/15  |  Presentations | -  |  -  |  -  |
...
- *Take-home midterm*: You will have one week to complete each take-home midterm exam. Each will involve data analysis, theory from the textbook, or interpretation of experimental results from a published paper. 
...
- *Lab Exercises*: There are a variety of end-of-chapter exercises in *Data Computing*. You will regularly submit answers to these ( they are not meant to take longer than 30-60 mins). The exact number of submissions TBD. 

##In-class Experiments
We will use [VEconLab]("http://veconlab.econ.virginia.edu/admin.htm") to run in-class experiments, typically during the Thursday class-times. I'm also investigating two alternative platforms: [MobLab]("https://www.moblab.com") and [economics-games]("http://economics-games.com").
...
##Team Meeting
Please register for a team meeting with me on Doodle here: [doodle.com/a69htymvp2fserf3]("https://doodle.com/a69htymvp2fserf3").
I have meeting slots on Tuesday and Thursday of the last two weeks of the semester *before* fall break. *Only register for the meetince once your teams are confirmed* (just in case you're very keen).
...
- initial meeting with me before fall break
...
Dr. Cat McCune of the Spinelli Quantitative Learning Center and I have devised a program to evaluate and revise your statistical knowledge in a Spinelli QLC Stats Workshop. The program will also offer workshops on Excel to make sure you have that infrastructure in place before using R. 
...
- It is the first time I am teaching ECO254. 
...
##Acknowledgments
In developing this syllabus, I have drawn on resources from variety of people: Jennifer Imazeki, John Spraggon, Shyam Sunder, Daniel Kaplan, Richard Ball, and others who I probably don't realize I pilfered from. Thanks to all of you.  
