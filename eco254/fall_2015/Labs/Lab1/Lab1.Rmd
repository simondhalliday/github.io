...
throughout the course both to revise the statistical concepts discussed in the 
texbook and also to analyze real data and come to informed conclusions. Let us clarify which is which:
...
Participation$female #So they understand a vector and typing out the name of an object
```
