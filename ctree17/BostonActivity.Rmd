---
title: 'CTREE Workshop Activity: Replicating (some of) the Harrison and Rubinfeld
  results'
...
A comparison of Table V and the results above shows that some of the variables are not in the approporiate units to replicate the summary statistics. Let's using the `dlpyr` package to create a modified dataset with renamed and appropriately rescaled values.
