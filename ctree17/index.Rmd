...
- Go to the following url: [104.236.95.197/rstudio](104.236.95.197/rstudio)
...
```{r}
library(readr)
GroupedData <- read_csv("http://simondhalliday.github.io/ctree17/data/GroupedbyType.csv")
quantity <- read_csv("http://simondhalliday.github.io/ctree17/data/quantity.csv")
```
