require(ggplot2)
require(shape)
pdf(file = "property_fig1b.pdf", width = 9, height = 7)
...
lines(xx1, indiffcurveB1(xx1), col = COL[3], lwd = 4)
lines(xx1, indiffcurveB2(xx1), col = COL[3], lwd = 4)
lines(xx1, indiffcurveB3(xx1), col = COL[3], lwd = 4)
