...
```{r production intro, fig.margin = TRUE, fig.cap = "Introductory page to Chapter 8: Production: Technology, Costs and Supply", echo = FALSE}
knitr::include_graphics('./images/BFHMicro_production_intro.jpg')
```

```{r eos ppf, fig.margin = TRUE, fig.cap = "Chapter 7: Economies of Scale and the Production Possibilities Frontier", echo = FALSE}
