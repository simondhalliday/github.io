...
We may not have burned as much of the mathematics as much as we ought to have done, but we try to restrain it to when it is most necessary. For the most part, the economics is conveyed through *graphical* intuition with algebra. All of the graphics are also available on github. We hope later to provide interactive versions of the majority of the important graphics.  


##Quizzes
We will be providing access to multiple choice and checkbox quizzes for each chapter which we hope to have for each chapter after the summer. They will use the new Google Quiz interface. Either our RA or I will provide access to the quiz, which an instructor will then be able to duplicate and edit for use with their own classes. Though Google quizzes are not yet as powerful as quizzes on Moodle or blackboard, their portability and ease of use suits our needs well for the moment.  
